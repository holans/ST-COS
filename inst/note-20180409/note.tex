...
%
\begin{enumerate*}
\item[a.] For the 1-year lookback, we take $Z^{(1)}_t(A)$ and $\sigma^2_{t,1}(A)$ to be sample means and variances of the units in $\mathcal{S}_t(A)$.
\item[b.] For the 3-year lookback, we take $Z^{(3)}_t(A)$ and $\sigma^2_{t,3}(A)$ to be sample means and variances of the units in $\bigcup_{j=0}^2 \mathcal{S}_{t-j}(A)$.
\item[c.] For the 5-year lookback, we take $Z^{(5)}_t(A)$ and $\sigma^2_{t,5}(A)$ to be sample means and variances of the units in $\bigcup_{j=0}^4 \mathcal{S}_{t-j}(A)$.
\end{enumerate*}
%
