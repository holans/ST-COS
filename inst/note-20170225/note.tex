...
\end{lstlisting}
%
I think \code{M} should instead be based on the eigenvectors of $I - X(X^T X)^{-1} X^T$, where $X = (H \; I)$. But it looks like $P$ is not computable. In general, for a block matrix, we have
%
\begin{align*}
\begin{bmatrix}
A & B \\
