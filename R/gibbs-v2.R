# Here xi is integrated out, so we either need to use a computational
# method to sample sig2xi, or leave it fixed at the MLE (Empirical Bayes)
gibbs.stcos.v2 <- function(Z, S, sig2eps, C.inv, H, R,
